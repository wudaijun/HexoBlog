...
NGServer中的消息定义于Message.h中，主要定义了如下几种消息，它们的继承体系如下：
 ...
 ![](/assets/NGServer_Message_Hierarchy.png "Message继承体系")
...
![](/assets/NGServer_Service_Hierarchy.png "Service继承体系")
...
![](/assets/NGServer_Service_ClassInterface.png "Service类接口")
